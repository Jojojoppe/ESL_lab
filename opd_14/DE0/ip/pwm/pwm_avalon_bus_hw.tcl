...
## IP details
##  
set_module_property DESCRIPTION "ESL pwm"
set_module_property NAME esl_pwm
set_module_property VERSION 1.0
set_module_property GROUP Templates
set_module_property AUTHOR esl22
set_module_property DISPLAY_NAME esl_pwm
set_module_property TOP_LEVEL_HDL_FILE pwm_avalon_bus.vhdl
set_module_property TOP_LEVEL_HDL_MODULE pwm_avalon_bus
...
add_file pwm_avalon_bus.vhdl {SYNTHESIS SIMULATION}
add_file FDIV.vhd {SYNTHESIS SIMULATION}
...
add_interface_port pwm_interface ina ina Bidir 1
add_interface_port pwm_interface inb inb Bidir 1
add_interface_port pwm_interface inc inc Output 1
