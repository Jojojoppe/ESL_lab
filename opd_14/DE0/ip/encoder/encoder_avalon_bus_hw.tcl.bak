...
## IP details
##  
set_module_property DESCRIPTION "ESL encoder"
set_module_property NAME esl_encoder
set_module_property VERSION 1.0
set_module_property GROUP Templates
set_module_property AUTHOR esl22
set_module_property DISPLAY_NAME esl_encoder
set_module_property TOP_LEVEL_HDL_FILE encoder_avalon_bus.vhdl
set_module_property TOP_LEVEL_HDL_MODULE encoder_avalon_bus
...
##  
add_file encoder.vhdl {SYNTHESIS SIMULATION}
add_file encoder_avalon_bus.vhdl {SYNTHESIS SIMULATION}
...
add_interface leds_interface conduit end
add_interface_port leds_interface leds leds Output 1

add_interface encoder_a_interface conduit end
add_interface_port encoder_a_interface encoder_a encoder_a Input 1

add_interface encoder_b_interface conduit end
add_interface_port encoder_b_interface encoder_b encoder_b Input 2
...
proc elaborate_me {}  {
  ...
  set_port_property leds WIDTH $the_led_width
